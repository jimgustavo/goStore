...
-- Dumping database structure for goStore
CREATE DATABASE IF NOT EXISTS `goStore` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `goStore`;

-- Dumping structure for table goStore.customers
...
-- Dumping data for table goStore.customers: ~4 rows (approximately)
...
-- Dumping structure for table goStore.orders
...
-- Dumping data for table goStore.orders: ~11 rows (approximately)
...
-- Dumping structure for table goStore.products
...
-- Dumping data for table goStore.products: ~6 rows (approximately)
